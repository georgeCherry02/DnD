<?php
    ...
    $dropdown_count++;
?>
<div id="create_form_dropdown_<?php echo $item_type->getName() ?>" class="create_form_dropdown white_background grey_border" onmouseover="this.style.maxHeight='<?php echo $max_height_on_hover; ?>'" onmouseout="this.style.maxHeight= 'calc(2em - 4px)'" style="z-index: <?php echo $z_index; ?>; display: <?php echo $visibility_style; ?>;">
    ...
    <?php
        foreach ($items[$item_type->getName()] as $item) {
            ...
            echo "<div class=\"".$item_type->getName()."_radio grey_border white_background\" onclick=\"toggle_radio(".$item["ID"].", '".$item_type->getName()."', this)\" id=\"".$item_type->getName()."_radio\"></div>";
            echo "<br/>";
        }
    ?>
</div>
